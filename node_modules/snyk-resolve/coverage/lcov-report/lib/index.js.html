...
<div class='wrapper'>
  <div class='pad1'>
    ...
    <div class='clearfix'>
      ...
      <div class='fl pad1y'>
        <span class="strong">3 statements, 1 branch</span>
...
&nbsp;
  var isFile = function (file) {
    ...
    try {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (error &amp;&amp; error.code === 'ENOENT') {
        return false;
      }
    }
...
function parse(dir) {
  ...
  <span class="skip-if-branch" title="else path not taken" >E</span>if (path.parse) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Jan 22 2016 13:20:02 GMT+0000 (GMT)
</div>
</div>
