...
import { Ecosystem, EcosystemMonitorResult, EcosystemMonitorError } from './types';
export declare function monitorEcosystem(ecosystem: Ecosystem, paths: string[], options: Options): Promise<[EcosystemMonitorResult[], EcosystemMonitorError[]]>;
